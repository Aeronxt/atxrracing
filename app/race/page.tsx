      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-4">
          ...
          <div className="relative">
            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-red-600" />
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-4 mb-4">
                          <StepIcon className="h-8 w-8 text-red-500" />
                          <div>
              ...
              <TabsContent key={category} value={category}>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {[1, 2, 3].map((index) => (
                    ...
                    >
                      <Image
                        src={`/images/${category}-test-${index}.jpg`}
                        alt={`${category.toUpperCase()} Testing`}
                        fill
                        className="object-cover"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent p-6 flex flex-col justify-end">
                        <h3 className="text-xl font-bold mb-2">Test Location {index}</h3>
                        <p className="text-sm text-gray-300">Professional coaching and data analysis included</p>
                      </div>
                    </motion.div>
                  ))}
                </div>
